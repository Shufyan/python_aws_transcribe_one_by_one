...
def start_job(
    ...
    try:
        ...
        if config['aws_s3_config']['out_bucket_name'] is not None:
            job_args['OutputBucketName'] = config['aws_s3_config']['out_bucket_name']

        job_args['Settings'] = config['aws_transcribe_config']['Settings']
